...
MODULE shared_data
  ...
  INTEGER, PARAMETER :: c_dump_part_opdepth_delt = 67
  INTEGER, PARAMETER :: c_dump_probe_time        = 68
#ifdef WORK_DONE_INTEGRATED
  INTEGER, PARAMETER :: c_dump_part_work_x       = 69
  INTEGER, PARAMETER :: c_dump_part_work_y       = 70
  INTEGER, PARAMETER :: c_dump_part_work_z       = 71
  INTEGER, PARAMETER :: c_dump_part_work_x_total = 72
  INTEGER, PARAMETER :: c_dump_part_work_y_total = 73
  INTEGER, PARAMETER :: c_dump_part_work_z_total = 74
  ...
  REAL(num) :: hybrid_idx, hybrid_idy, hybrid_idz
  ...
  REAL(num), ALLOCATABLE :: urb_d1(:,:,:), urb_d2(:,:,:), urb_d3(:,:,:)
  REAL(num), ALLOCATABLE :: urb_d4(:,:,:), urb_iZ23(:,:,:), urb_theta1(:,:,:)
  REAL(num), ALLOCATABLE :: urb_theta2(:,:,:), urb_Zeff(:,:,:)
  REAL(num), ALLOCATABLE :: urb_rad_len(:,:,:)
