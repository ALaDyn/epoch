...
CONTAINS
  ...
  SUBROUTINE redistribute_fields(new_domain)
    ...
    IF (use_hybrid) THEN
      ...
      DEALLOCATE(comp_id)
      ALLOCATE(comp_id(1-ng:nx_new+ng))
      comp_id = temp_int
      ...
      ALLOCATE(hybrid_const_sum_ne(1-ng:nx_new+ng))
  ...
  SUBROUTINE remap_field_logic(field_in, field_out)
    ...
    CALL redistribute_field_1d_logic(field_in, field_out, cdim, &
        cell_x_min, cell_x_max, new_cell_x_min, new_cell_x_max)

    CALL do_field_mpi_with_lengths_logic(field_out, ng, n_new(1))
  ...
  SUBROUTINE redistribute_field_1d_logic(field_in, field_out, cdim, &
      old_cell_min1, old_cell_max1, new_cell_min1, new_cell_max1)

    ! This subroutine redistributes the fields over the new processor layout
    INTEGER, PARAMETER :: nd = 1
    LOGICAL, DIMENSION(1-ng:), INTENT(IN) :: field_in
    LOGICAL, DIMENSION(1-ng:), INTENT(OUT) :: field_out
    INTEGER, DIMENSION(nd), INTENT(IN) :: cdim
    INTEGER, DIMENSION(:), INTENT(IN) :: old_cell_min1, old_cell_max1
    INTEGER, DIMENSION(:), INTENT(IN) :: new_cell_min1, new_cell_max1
    INTEGER :: irank, basetype, n, ng0, ng1
  ...
  END SUBROUTINE redistribute_field_1d_logic
